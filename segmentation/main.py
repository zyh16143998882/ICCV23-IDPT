...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='prompt_pt3', help='model name')
    parser.add_argument('--optimizer_part', type=str, default='only_new', help='training all parameters or optimizing the new layers only')
